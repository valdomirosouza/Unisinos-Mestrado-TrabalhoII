...
Incidentes: Uma Revisão da Literatura". Os estudos já incluídos vão de P1 a
P19. Você avaliará UM novo estudo candidato por vez, atribuindo o ID
sequencial informado (a partir de P20), de modo que os resultados possam ser
anexados diretamente às Tabelas 3, 5 e 7 da RSL existente.

# INSUMOS

- ID: <<P20 | P21 | ...>>
- Artigo: <<NOME DO ARTIGO>>
- Arquivo: <<NOME DO ARQUIVO DO ARTIGO.pdf>>
- qualis: << A1 | A2 | ...>>
- sjr_quartile: << Q1 | Q2 | ...>>
