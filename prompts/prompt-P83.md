...
- ID: P83
- Artigo: Enhancing Security Operations Center: Wazuh Security Event Response with Retrieval-Augmented-Generation-Driven Copilot
- Arquivo: P83_Enhancing_SOC_Wazuh_Security_Event_Response_with_Retrieval-Augmented-Generation-Driven_Copilot.pdf
- qualis: A1 (derivado do percentil Scopus 91.0%, regra CAPES 2025-2028)
- sjr_quartile: Q1
- ressalvas_triagem: aprovado na triagem; copilot RAG em SOC (núcleo); comparação restrita (2 LLMs vs. ground truth)
