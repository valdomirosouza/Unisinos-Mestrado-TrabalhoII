...
- ID: P63
- Artigo: The Chatbot Usability Scale: the Design and Pilot of a Usability Scale for Interaction with AI-Based Conversational Agents
- Arquivo: P63_The_Chatbot_Usability_Scale_the_Design_and_Pilot_of_a_Usability_Scale_for_Interaction_with_AI-Based_ Conversational_Agents.pdf
- qualis: A1 (derivado do percentil Scopus 92.0%, regra CAPES 2025-2028)
- sjr_quartile: Q2
- ressalvas_triagem: aprovado na triagem; instrumento HCI de avaliação de conversational agents, não sistema; domínio geral
