...
- ID: P18
- Artigo: An architecture for model-based and intelligent automation in DevOps
- Arquivo: P18-A1 - An architecture for model-based and intelligent automation in DevOps.pdf
- qualis: A1
- sjr_quartile: Q1
