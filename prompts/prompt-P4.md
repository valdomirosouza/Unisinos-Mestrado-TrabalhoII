...
- ID: P4
- Artigo: LLM-Based Multi-Agent Systems for Software Engineering: Literature Review, Vision and the Road Ahead
- Arquivo: P4-A2 - LLM-Based Multi-Agent Systems for Software Engineering Literature Review Vision and the Road Ahead.pdf
- qualis: A2
- sjr_quartile: Q1
