...
Act as a researcher in Applied Computing at PPGCA (Unisinos) advised by a professor holding a Doctorate in Computer Science, specialized in systematic literature reviews — following the guidelines of Kitchenham (2009) in the paper "Systematic literature reviews in software engineering – A systematic literature review" — in the fields of Site Reliability Engineering (SRE), AIOps, and applied Artificial Intelligence.
...
- **1.1.0** — SYSTEM / ROLE updated: persona changed from generic expert
  assistant to "researcher in Applied Computing at PPGCA (Unisinos) advised by
  a professor holding a Doctorate in Computer Science", and the methodology
  reference anchored to Kitchenham (2009), "Systematic literature reviews in
  software engineering – A systematic literature review" — mirroring the same
  changes applied to `picoc/picoc-extraction-prompt.md` (v1.2.0 and v1.3.0).
- **1.0.0** — Initial version (11-field extraction schema, strict
  anti-fabrication rules, evidence anchors, self-check).
